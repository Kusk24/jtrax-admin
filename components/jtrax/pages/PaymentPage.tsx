...
import { PAYMENTS_SEED, STUDENTS_SEED, type Payment } from "@/lib/jtrax/data";
import { Icon } from "@/lib/jtrax/icons";
import { classDotColor, COLORS, FONT, initialsOf, statusChipColors, TODAY_REF } from "@/lib/jtrax/theme";
import {
  EmptyRow,
  fieldStyle,
  FilterBar,

...
import { searchStudents } from "@/lib/jtrax/derive";
import { CLASSES_DEFS_REF } from "@/lib/jtrax/data";
import { Icon } from "@/lib/jtrax/icons";
import { COLORS, FONT, initialsOf, statusChipColors } from "@/lib/jtrax/theme";
          ...
          {results.length === 0 ? (
            ...
            >
              ...
              <button
                ...
                onClick={() => router.push(`/jtrax/students?new=${encodeURIComponent(query)}`)}
                style={{
                  display: "inline-flex",
                  alignItems: "center",
                  gap: 8,

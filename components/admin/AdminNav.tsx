...
const tabs = [
  { href: "/super", labelKey: "dashboard", icon: LayoutDashboard },
  { href: "/super/admins", labelKey: "branchAdmins", icon: UserCog },
  { href: "/super/branches", labelKey: "branches", icon: Building2 },
  { href: "/super/courses", labelKey: "courses", icon: GraduationCap },
  { href: "/super/teachers", labelKey: "teachers", icon: Presentation },
  { href: "/super/students", labelKey: "students", icon: Users },
  { href: "/super/payments", labelKey: "payments", icon: CreditCard },
  { href: "/super/attendance", labelKey: "attendance", icon: ClipboardList },
  { href: "/super/reports", labelKey: "reports", icon: TrendingUp },
  { href: "/super/settings", labelKey: "system", icon: Settings },
] as const;
  ...
  return (
    <nav className="flex flex-1 flex-col gap-1 overflow-y-auto">
      {tabs.map(({ href, labelKey, icon: Icon }) => {
        const active =
          href === "/super" ? pathname === href : pathname.startsWith(href);
        return (
          <Link
            key={href}
            href={href}
    ...
    <>
      <header className="fixed inset-x-0 top-0 z-40 border-b-2 border-line bg-card">
        <div className="flex h-16 items-center gap-3 px-4 sm:px-6">
          ...
          <Link href="/super" className="flex min-w-0 items-center gap-2.5">
